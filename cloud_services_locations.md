...
{: caption="Table 1. Analytics services integration in Asia Pacific locations" caption-side="top"}
{: #analytics-table-2}
...
{: caption="Table 3. Compute infrastructure services integration in America locations" caption-side="top"}
{: #cs_infra-table-1}
{: tab-title="America"}
{: tab-group="cs_infra"}
{: class="simple-tab-table"}
...
{: caption="Table 4. Compute serverless services integration in Asia Pacific locations" caption-side="top"}
{: #cs_comp-table-2}
{: tab-title="Asia Pacific"}
{: tab-group="cs_comp"}
{: class="simple-tab-table"}
...
{: caption="Table 7. Container services integration in America locations" caption-side="top"}
...
{: caption="Table 7. Container services integration in Europe locations" caption-side="top"}
...
{: caption="Table 10. Database services integration in America locations" caption-side="top"}
{: #cs-dbs-table-1}
{: tab-title="America"}
{: tab-group="cs_dbs"}
{: class="simple-tab-table"}
...
| {{site.data.keyword.messages-for-rabbitmq_full_notm}}           | ![Checkmark icon](images/checkmark-icon.svg)    | `NO`             | `Events are available through the Tokyo instance` | `Events are available through the Tokyo instance` | `NO`             |
| {{site.data.keyword.databases-for-redis_full_notm}}             | ![Checkmark icon](images/checkmark-icon.svg)    | `NO`             | `Events are available through the Tokyo instance` | `Events are available through the Tokyo instance` | `NO`             |
{: caption="Table 10. Database services integration in Asia Pacific locations" caption-side="top"}
{: #cs-dbs-table-2}
{: tab-title="Asia Pacific"}
{: tab-group="cs_dbs"}
{: class="simple-tab-table"}
...
|---------------------------------------------------------------|---------------------|------------------|---------------------------|
| {{site.data.keyword.cloudant_short_notm}}                     | ![Checkmark icon](images/checkmark-icon.svg) | ![Checkmark icon](images/checkmark-icon.svg) | `NO`                      |
...
{: caption="Table 10. Database services integration in Europe locations" caption-side="top"}
{: #cs-dbs-table-3}
{: tab-title="Europe"}
{: tab-group="cs_dbs"}
{: class="simple-tab-table"}
...
{: caption="Table 11. Developer tools services integration in America locations" caption-side="top"}
...
{: caption="Table 11. Developer tools services integration in Asia Pacific locations" caption-side="top"}
...
| {{site.data.keyword.DRA_full}}                 | ![Checkmark icon](images/checkmark-icon.svg)  | ![Checkmark icon](images/checkmark-icon.svg) |  
| {{site.data.keyword.bplong}}                   |  `NO`  | `NO` |    
{: caption="Table 11. Developer tools services integration in Europe locations" caption-side="top"}
...
{: caption="Table 12. Integration services integration in America locations" caption-side="top"}
...
{: caption="Table 12. Integration services integration in Asia Pacific locations" caption-side="top"}
...
{: caption="Table 12. Integration services integration in Europe locations" caption-side="top"}
...
{: caption="Table 14. Security services integration in America locations" caption-side="top"}
{: #cs-sec-table-1}
{: tab-title="America"}
{: tab-group="cs_sec"}
{: class="simple-tab-table"}
...
{: caption="Table 14. Security services integration in Asia Pacific locations" caption-side="top"}
{: #cs-sec-table-2}
{: tab-title="Asia Pacific"}
{: tab-group="cs_sec"}
{: class="simple-tab-table"}
...
{: caption="Table 14. Security services integration in Europe locations" caption-side="top"}
{: #cs-sec-table-3}
{: tab-title="Europe"}
{: tab-group="cs_sec"}
{: class="simple-tab-table"}
...
{: caption="Table 15. Storage services integration in America locations" caption-side="top"}
{: #cs_storage-table-1}
{: tab-title="America"}
...
{: caption="Table 15. Storage services integration in Asia Pacific locations" caption-side="top"}
{: #cs_storage-table-2}
{: tab-title="Asia Pacific"}
{: tab-group="cs_storage"}
{: class="simple-tab-table"}
...
| {{site.data.keyword.cos_full_notm}}  `[*]`        | ![Checkmark icon](images/checkmark-icon.svg) |  ![Checkmark icon](images/checkmark-icon.svg)  | 
| {{site.data.keyword.mdms_short}}            |   |       |  
{: caption="Table 15. Storage services integration in Europe locations" caption-side="top"}
{: #cs_storage-table-3}
{: tab-title="Europe"}
{: tab-group="cs_storage"}
{: class="simple-tab-table"}
...
{: caption="Table 16. Web and mobile services integration in America locations" caption-side="top"}
{: #cs_web-table-1}
{: tab-title="America"}
{: tab-group="cs_web"}
{: class="simple-tab-table"}
...
{: caption="Table 16. Web and mobile services integration in Asia Pacific locations" caption-side="top"}
{: #cs_web-table-2}
{: tab-title="Asia Pacific"}
{: tab-group="cs_web"}
{: class="simple-tab-table"}
...
|---------------------------------------------------------------|---------------------|------------------|
| {{site.data.keyword.mobilefoundation_short}}   | ![Checkmark icon](images/checkmark-icon.svg)  | ![Checkmark icon](images/checkmark-icon.svg)   |   
{: caption="Table 16. Web and mobile services integration in Europe locations" caption-side="top"}
{: #cs_web-table-3}
{: tab-title="Europe"}
{: tab-group="cs_web"}
{: class="simple-tab-table"}
...
{: caption="Table 17. VPC events in America locations" caption-side="top"}
{: #cs-vpc-table-1}
{: tab-title="America"}
{: tab-group="cs_vpc"}
{: class="simple-tab-table"}
...
| Images                                 |     |     |           
{: caption="Table 17. VPC events in Asia Pacific locations" caption-side="top"}
{: #cs-vpc-table-2}
{: tab-title="Asia Pacific"}
{: tab-group="cs_vpc"}
{: class="simple-tab-table"}
...
| VPN                                    | `Events are available through the Activity Tracker US-South instance` | `Events are available through the Activity Tracker US-South instance` |   
| Images                                 |     |     |         
{: caption="Table 17. VPC events in Europe locations" caption-side="top"}
{: #cs-vpc-table-3}
{: tab-title="Europe"}
{: tab-group="cs_vpc"}
{: class="simple-tab-table"}
...
| VPN                                    | ![Checkmark icon](images/checkmark-icon.svg)  | `Events are available through the Activity Tracker US-South instance` |
| Images                                 | ![Checkmark icon](images/checkmark-icon.svg)  | ![Checkmark icon](images/checkmark-icon.svg) |
{: caption="Table 18. VPC events in America locations" caption-side="top"}
{: #cs-vpc-gen2-table-1}
{: tab-title="America"}
...
| VPN                                    |        | | 
| Images                                 |     |     |           
{: caption="Table 18. VPC events in Asia Pacific locations" caption-side="top"}
{: #cs-vpc-gen2-table-2}
{: tab-title="Asia Pacific"}
{: tab-group="cs_vpc_gen2"}
{: class="simple-tab-table"}
...
| VPN                                    | `Events are available through the Activity Tracker US-South instance` | `Events are available through the Activity Tracker US-South instance` |   
| Images                                 | ![Checkmark icon](images/checkmark-icon.svg) | ![Checkmark icon](images/checkmark-icon.svg)    |         
{: caption="Table 18. VPC events in Europe locations" caption-side="top"}
{: #cs-vpc-gen2-table-3}
{: tab-title="Europe"}
{: tab-group="cs_vpc_gen2"}
{: class="simple-tab-table"}
...
{: caption="Table 19. Watson AI services integration in Asia Pacific locations" caption-side="top"}
{: #cs_watsonai-table-2}
{: tab-title="Asia Pacific"}
{: tab-group="cs_watsonai"}
{: class="simple-tab-table"}
...
{: caption="Table 19. Watson AI services integration in Europe locations" caption-side="top"}
{: #cs_watsonai-table-3}
{: tab-title="Europe"}
{: tab-group="cs_watsonai"}
{: class="simple-tab-table"}
