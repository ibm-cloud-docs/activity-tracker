...
* The hourly archive directory format looks like this:
    ...
    `<accountID>` represents the LogDNA account ID, that is, the ID that showd in the [UI URL](/docs/Activity-Tracker-with-LogDNA?topic=Activity-Tracker-with-LogDNA-get_logdna_web_url).
