...
Do not configure a long-term retention policy on a COS bucket if you need access to the data and need to query it with the {{site.data.keyword.sqlquery_full}} service.
{: important}
