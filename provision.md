...
2. Go to the **Menu** icon ![Menu icon](images/icon_hamburger.svg "Screen cap that shows the menu icon"). Then, select **Observability** to access the *Observability* dashboard.
