...
2. Go to the **Menu** icon ![Menu icon](icon_hamburger.svg "Screen cap that shows the menu icon"). Then, select **Observability** to access the *Observability* dashboard.
