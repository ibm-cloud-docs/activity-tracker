...
For more information about action values that are generated by services, see [Cloud services](/docs/Activity-Tracker-with-LogDNA?topic=Activity-Tracker-with-LogDNA-cloud_services#cloud_services).
