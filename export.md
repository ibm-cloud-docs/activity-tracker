...
| `query`     | `string`     | Optional   | [Search query](/docs/services/Log-Analysis-with-LogDNA?topic=LogDNA-view_logs#view_logs_step6).  </br>You can test your query in a view in the LogDNA web UI. </br>Use `%20` to represent a space.|
