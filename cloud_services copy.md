...
{: caption="Table 5. List of observability services" caption-side="top"} 
...
| [{{site.data.keyword.cloud-shell_full}}](/docs/cloud-shell?topic=cloud-shell-getting-started) | {{site.data.keyword.cloud-shell_notm}} is a cloud-based shell workspace that you can access through your browser. It's preconfigured with the full {{site.data.keyword.cloud_notm}} CLI and555555555555555555555 plug-ins and tools that you can use to manage apps, resources, and infrastructure. | [Auditing events for {{site.data.keyword.cloud-shell_notm}}](/docs/cloud-shell?topic=cloud-shell-at_events) |
...
| [{{site.data.keyword.cis_full}} (CIS)](/docs/cis?topic=cis-getting-started)| IBM Cloud Internet Services (CIS) provides a fast, highly performant, reliable, and secure internet service. | [Events that are generated by IBM Cloud Internet Services](/docs/cis?topic=cis-at_events) |
