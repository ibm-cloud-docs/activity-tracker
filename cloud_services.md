...
| [{{site.data.keyword.satellitelong}}](/docs/satellite?topic=satellite-getting-started) | With {{site.data.keyword.satellitelong_notm}}, you can bring your own compute infrastructure to run {{site.data.keyword.cloud_notm}} services and consistently deploy, manage, and control your app workloads. | [Events that are generated when you interact with {{site.data.keyword.satellitelong_notm}}](/docs/satellite?topic=satellite-at_events). |
...
| [{{site.data.keyword.vpc_full}}](/docs/vpc?topic=vpc-getting-started)| With IBM Cloud™ Virtual Private Cloud (VPC), you can use the UI, CLI, and API to quickly provision generation 2 virtual server instances for VPC with high network performance. |[Events that are generated by Virtual Private Cloud](/docs/vpc?topic=vpc-at-events)|
