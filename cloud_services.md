...
| [IBM Cloud DNS Services](/docs/dns-svcs?topic=dns-svcs-about-dns-services)| IBM Cloud DNS Services provides private DNS to Virtual Private Cloud (VPC) users. | [Events that are generated by IBM Cloud DNS Services](/docs/dns-svcs?topic=dns-svcs-at_events) |
