...
These services generate events that you can view through the **Frankfurt (eu-de)** {{site.data.keyword.at_full_notm}} web UI. To view these events, you must [provision an instance](/docs/Activity-Tracker-with-LogDNA?topic=Activity-Tracker-with-LogDNA-provision#provision) of the {{site.data.keyword.at_full_notm}} service in the **Frankfurt (eu-de)** region.
{: note}

| Service                          | Service names | Description | Events |
|----------------------------------|--------------|-------------|-------------------| 
...
| [{{site.data.keyword.security-advisor_long}}](/docs/security-advisor?topic=security-advisor-getting-started) | `security-advisor` | You can use {{site.data.keyword.security-advisor_short}} to instantly view the security posture of your {site.data.keyword.cloud_notm}} services through a single, centralized dashboard. | [Events](/docs/security-advisor?topic=security-advisor-at_events#events). |
| [{{site.data.keyword.at_full}}](/docs/Activity-Tracker-with-LogDNA?topic=Activity-Tracker-with-LogDNA-getting-started) | {{site.data.keyword.at_full_notm}} monitors the activity of your {{site.data.keyword.cloud_notm}} account. | [Events](/docs/Activity-Tracker-with-LogDNA?topic=Activity-Tracker-with-LogDNA-at_events). |
{: caption="Table 8a. List of core security platform services" caption-side="top"}
...
{: caption="Table 8b. List of core security platform services" caption-side="top"}
