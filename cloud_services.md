...
| Service     | Description | Events    |
|-------------|-------------|-----------|
| {{site.data.keyword.vmwaresolutions_short}}   | Use {{site.data.keyword.vmwaresolutions_short}} to track how users and applications interact with Virtual Data Centers. | [Events that are generated](/docs/vmwaresolutions?topic=vmwaresolutions-at-events#at-events-vd) |
...
| [Managing catalogs](/docs/account?topic=account-acct_iam_trackin/docs/account?topic=account-filter-account) | You can create, organize, and manage catalogs. | [Events that are generated when you manage catalogs](/docs/Activity-Tracker-with-LogDNA?topic=Activity-Tracker-with-LogDNA-at_events_acc_mgt#at_events_catalog_management). |
