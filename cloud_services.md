...
| [{{site.data.keyword.databases-for-enterprisedb_full}}](/docs/databases-for-enterprisedb?topic=databases-for-enterprisedb-getting-started) | {{site.data.keyword.databases-for-enterprisedb}} is an open source administration platform for PostgreSQL that provides many tools for managing your data and databases. | [Events that are generated by {{site.data.keyword.databases-for-enterprisedb}}](/docs/databases-for-enterprisedb?topic=cloud-databases-activity-tracker) | 
