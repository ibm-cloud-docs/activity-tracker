...
| Service     | Description | Events    |
|-------------|-------------|-----------|
| {{site.data.keyword.vmwaresolutions_short}}   | Use {{site.data.keyword.vmwaresolutions_short}} to track how users and applications interact with Virtual Data Centers. | [Events that are generated](/docs/vmwaresolutions?topic=vmwaresolutions-at-events#at-events) |
| vCenter Server      | Use vCenter Server to manage user accounts, instances, clusters, and services in {{site.data.keyword.vmwaresolutions_short}}. | [Events that are generated](/docs/vmwaresolutions?topic=vmwaresolutions-at-events#at-events-instance-mgmt) |
| KMIP for VMware | KMIP for VMware works together with VMware native vSphere encryption and vSAN encryption to provide simplified storage encryption management together with the security and flexibility of {{site.data.keyword.keymanagementservicelong_notm}} or {{site.data.keyword.hscrypto}} customer-managed keys. | [Events that are generated](/docs/vmwaresolutions?topic=vmwaresolutions-at-events#at-events-kmip) | |
