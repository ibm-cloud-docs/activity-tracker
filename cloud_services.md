...
<<<<<<< HEAD
[{{site.data.keyword.tg_full}}](/docs/dl?topic=dl-get-started-with-ibm-cloud-dl) | Use {{site.data.keyword.tg_full_notm}} to interconnect {{site.data.keyword.cloud_notm}} classic and Virtual Private Cloud (VPC) infrastructures worldwide, keeping traffic within the {{site.data.keyword.cloud_notm}} network. | [Events that are generated by {{site.data.keyword.tg_full_notm}}](/docs/transit-gateway?topic=transit-gateway-at_events) |
...
=======
| [{{site.data.keyword.dns_full}}](/docs/dns-svcs?topic=dns-svcs-getting-started) | {{site.data.keyword.dns_short}}  provides private DNS to Virtual Private Cloud (VPC) users.  | [Events that are generated by {{site.data.keyword.dns_short}}](/docs/dns-svcs?topic=dns-svcs-at_events) |
>>>>>>> 8113796a9b40dbca8868b06727c3e249173d3220
