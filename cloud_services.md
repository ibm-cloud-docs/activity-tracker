...
| [Apps](/docs/apps?topic=apps-getting-started) | Use this service to build enterprise-ready mobile and web applications in {{site.data.keyword.cloud_notm}} and take advantage of cloud extensions that are hosted by {{site.data.keyword.cloud_notm}}. | [Events that are generated by ](/docs/apps?topic=apps-at_events) |
