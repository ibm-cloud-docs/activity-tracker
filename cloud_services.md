...
| Image resources | When you provision {{site.data.keyword.vsi_is_short}}, you can select from the supported stock images or a custom image that you import from {{site.data.keyword.cos_full_notm}}. | [Events that are generated when you manage VPC images](/docs/vpc-on-classic?topic=vpc-on-classic-at-events#events-images) |
