...
| [{{site.data.keyword.speechtotextfull}}](/docs/speech-to-text?topic=speech-to-text-gettingStarted) | Transcribes audio to text to enable speech transcription capabilities for applications. | [Events that are generated by {{site.data.keyword.speechtotextshort}}](/docs/speech-to-text?topic=speech-to-text-at_events) |  |
