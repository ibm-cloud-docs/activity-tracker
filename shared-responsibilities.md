...
| `Archive events for {{site.data.keyword.atracker_short}} hosted event search offerings`  | Provide the ablity to archive to a client configured Cloud Object Storage (COS) location and archive data hourly or daily. | Configure Cloud Object Storage per your requirements.   \n [Enable archiving of the Activity Tracker instance.](/docs/activity-tracker?topic=activity-tracker-archiving) |
