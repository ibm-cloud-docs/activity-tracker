...
| `Updates to {{site.data.keyword.at_short}} hosted event search offerings` | Provide major, minor, and patch version updates for {{site.data.keyword.at_full_notm}} interfaces. </br>Document changes in the [Release notes](https://logdna.zendesk.com/hc/categories/360001626492-Release-Notes){: external} | `N/A` | 
